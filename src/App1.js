        ...
        return(
            ...
            <div className="card-body">
                <div class="input-grup-mb-2">
                    <div class="input-grup-prepared">
                        <label class="input-group-text"> Berat (kg) :</label>
                    </div>
                    <input type="number" className="form-control" 
                    value={this.state.berat} onChange={this.BeratChange}/>
                </div>
                ...
                <div class="input-group-mb-2">
                    ...
                    <input type="number" className="form-control" 
                    value={this.state.tinggi} onChange={this.TinggiChange}/>
                </div>
            </div>

                <div className="class-footer">
                    <button className="form-control btn btn-secondary text-light" onClick={this.hitungBmi}> Hitung 
                    </button>
